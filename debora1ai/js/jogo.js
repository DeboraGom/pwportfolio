...
class createSnake {
    ...
    draw(){
      ...
      for(let i = 0; i < this.snakeTrail.length; i++){
        if(i == 0){
          this.gameContext.fillStyle ='#e62281';
        }else{
          this.gameContext.fillStyle ='#ff80bd';
        }
  ...
  class createApple {
    ...
    draw(){
      this.gotEat();
      this.gameContext.fillStyle = '#e74c3';
  ...
  class createGameBack {
    ...
    draw(){
      this.gameContext.fillStyle = '#68228B';
      ...
      if(this.lose){
        ...
        this.gameContext.fillText('Aperte espaço para recomeçar', 100, 250);
      }
    }
  }
